...
const Form = ({ block, page, onSubmit }) => {
  ...
  return (
    <div className={`website-form download-report ${s.block}`} onSubmit={submitForm}>
      ...
      <div className='container px-0'>
        <div className='row mx-0'>
          <div className='col-xl-6 ps-xl-0'>
            {!!block?.title && <h3 className={s.title}>{parse(block?.title)}</h3>}
            <div className="row">
              ...
              <div className="col-12">
                <label className={`${s.labelCheckboxGroup} w-100 justify-content-center justify-content-xl-start`}>
              ...
              <div className="col-12">
                <div className='d-flex justify-content-center justify-content-xl-start'>
                  <ButtonCta onClick={(e) => { }} type={'submit'} block={block?.submitButton} className={'d-flex align-items-center justify-content-center'}>
                    {!!block?.submitButton?.text && <span className="me-2">{parse(block?.submitButton?.text)}</span>}
