...
import * as s from "./ModuleCareerPathForm.module.css";


const ModuleCareerPathForm = ({ block, course }) => {
            ...
            <div className='col-12'>
              <div className={s.wrapper}>
                <div className='row mx-0 justify-content-between'>
                  {true == bp.lg && <div className='col-lg-5'>
...
export default ModuleCareerPathForm;
